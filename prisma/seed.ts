...
import { PrismaClient, Role, ResourceType, QuestionType, type Prisma } from '@prisma/client'
...
type SeedResourceInput = Omit<Prisma.ResourceCreateManyInput, 'id'> & { id: string }

async function upsertResources(input: {
  data: SeedResourceInput[]
  skipDuplicates?: boolean
}) {
  void input.skipDuplicates
  ...
  await upsertResources({
    data: [
      ...
      },
      {
        ...
        contentMd:
          '常见场景：\n- App 或陌生人索要与服务无关的敏感信息。\n- 群聊中被要求上传身份证照、人脸或验证码。\n\n正确做法：\n1) 仅在官方渠道提交最小必要信息。\n2) 对验证码、身份证照片、人脸信息保持高警惕。\n3) 发现异常索取时立即停止并核验客服。\n\n不要这么做：\n- 不把敏感信息发到群聊或私聊中。\n- 不因“怕麻烦”默认同意所有授权。\n\n证据清单：\n- 索取信息页面截图。\n- 对话记录与账号信息。\n- 异常登录或隐私泄露提示截图。',
        createdBy: teacher.id,
      },
      {
        id: 'res-7',
      ...
      },
      {
        ...
        contentMd:
          '常见场景：\n- 兼职广告承诺“高薪日结”，要求先交押金。\n- 工作内容、工时和结算方式模糊不清。\n\n正确做法：\n1) 核实招聘主体与联系方式，优先正规平台。\n2) 明确工作内容、时长、报酬并留存书面记录。\n3) 遇到拖欠工资或人身风险及时求助。\n\n不要这么做：\n- 不向陌生账户支付押金或培训费。\n- 不把身份证原件随意发送给陌生人。\n\n证据清单：\n- 招聘信息与聊天记录。\n- 转账记录、收款账户信息。\n- 岗位说明、工作时间和结算约定。',
        createdBy: teacher.id,
      },
      {
        id: 'res-11',
      ...
      },
      {
        ...
        contentMd:
          '情境：\n在群聊中长期辱骂、散布他人照片，受害同学被持续围观和嘲讽。\n\n处置建议：\n1) 第一时间截图保留聊天内容、发布时间和账号信息。\n2) 在平台内发起侵权举报并申请删除传播内容。\n3) 向班主任、家长说明情况，必要时报警或咨询 12348。\n4) 对持续侵害行为记录时间线，便于后续追责。\n\n不要这么做：\n- 不在群里对骂或“以暴制暴”。\n- 不私下发布对方隐私进行报复。\n\n证据清单：\n- 群聊完整截图（含时间与账号）。\n- 被传播图片/视频原件及链接。\n- 平台举报回执与处置记录。',
        createdBy: teacher.id,
      },
      {
        id: 'res-3',
    ...
    data: [
      {
        ...
        contentMd:
          '常见场景：\n- 被侮辱、造谣，或被恶意剪辑视频传播。\n- 未经同意偷拍并发布个人照片、头像。\n\n正确做法：\n1) 先保全证据：截图、链接、账号、发布时间。\n2) 通过平台投诉举报并申请下架内容。\n3) 向老师、家长说明情况，必要时报警或咨询 12348。\n\n不要这么做：\n- 不以辱骂、曝光隐私方式“反击”。\n- 不删除原始证据后再维权。\n\n证据清单：\n- 侵权内容页面与评论区截图。\n- 原帖链接、发布账号主页。\n- 平台处理回执、沟通记录。',
        createdBy: teacher.id,
      },
      {
        id: 'res-18',
      ...
      },
      {
        ...
        contentMd:
          '常见场景：\n- 商品与描述不符、售后拖延或拒不退款。\n- 被诱导脱离平台私下转账后出现纠纷。\n\n正确做法：\n1) 先留证据：订单、支付、聊天、商品页面。\n2) 先通过平台官方客服协商解决。\n3) 协商无果再走平台投诉、12315 等渠道。\n\n不要这么做：\n- 不先删记录再沟通维权。\n- 不接受口头承诺却无书面凭证。\n\n证据清单：\n- 订单详情和商品页面截图。\n- 支付流水、物流记录。\n- 商家与客服沟通记录。',
        createdBy: teacher.id,
      },
      {
        id: 'res-22',
