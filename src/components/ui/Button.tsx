...
export default function Button({
  ...
  const base =
    "inline-flex items-center justify-center font-bold transition-all active:scale-[0.96] disabled:opacity-50 disabled:cursor-not-allowed select-none";
  const sizes = {
  ...
  const variants = {
    primary:
      "bg-[var(--p-primary)] text-white shadow-md shadow-blue-100 hover:bg-[var(--p-primary-dark)] hover:shadow-blue-200",
    secondary:
    ...
    accent:
      "bg-[var(--p-accent)] text-white shadow-md shadow-blue-100 hover:bg-[var(--p-accent-dark)]",
    warning:
