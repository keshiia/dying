...
| **AI 普法助手** | 基于 OpenAI 兼容接口的对话式普法助手，带用户记忆，提供个性化法律学习建议 |
| **资源中心** | 案例、法条摘要、视频、文章等 64 条普法资源，支持分类检索 |
...
同时，AI 普法助手在每次对话时自动注入用户画像、学习进度与历史提问，实现**带记忆的个性化问答**。
...
| AI 接口 | OpenAI 兼容接口 | — | AI 普法助手（可配置任意兼容模型） |
